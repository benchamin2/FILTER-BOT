...
API_ID = int(environ.get('API_ID', '26690477'))
API_HASH = environ.get('API_HASH', '0100ad61187862ac73150a83bae1f680')
BOT_TOKEN = environ.get('BOT_TOKEN', "8558070890:AAHpPTXp7wn0OtJcg-lyKyZO8KkFyBc2YS8")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '568788715').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003360586290'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002150500751').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1003687089302') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-5257312342')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003434609136').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://abhijithr564_db_user:W3ZXl6N0Qrizx0bx@cluster0.zpjhial.mongodb.net/?appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+LGea4VEwltAwNGY1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/padakkam')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'PadakkamSupport') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/ifamarutha')
